...
try:
    ...
    print('pkg_resources cannot be imported probably because the pip package is not installed and/or using a '
          'legacy Python interpreter. Please refer to the Get Started section of the PHNX_SDF Programming Guide for '
...
if __name__ == "__main__":
    ...
    if len(not_satisfied) > 0:
        ...
        if sys.platform == "win32" and os.environ.get("MSYSTEM", None) == "MINGW32" and "/mingw32/bin/python" in sys.executable:
            ...
            print('Please refer to the Get Started section of the PHNX_SDF Programming Guide for setting up the required'
                  ' packages.')
